document.addEventListener("DOMContentLoaded", function () {
  ...
  function botonesZoomBase() {
    ...
    btnSuelo.style.left = "70%";

    btnAbajo.style.top = "30%";
    btnAbajo.style.left = "40%";

    btnFrente.style.top = "12%";
    btnFrente.style.left = "20%";

    btnDerecha.style.top = "10%";
  ...
  function zoomMesa() {
    ...
    //ajustar el top/left/button/right de cada uno
    btnBase.style.top = "80%";  
    btnBase.style.left = "60%";
    //darle la clase
  ...
  function checkResult() {
    ...
    if (isCorrect) {
      document.getElementById("result").innerHTML = "The room starts to tremble as the shelf reveals a <a href='./LORE/Library.html'>secret passage</a>.";
    }
  }
