document.addEventListener("DOMContentLoaded", function () {
  ...
  var textEnterRoom = [
        ...
        function () {
          return !acceptFate && lastButtonTouched != null && lastButtonTouched.localeCompare("Fairy") == 0
            ...
            : [
                ...
                "elemental/fairy/badEnding1.png",
              ];
        },
        function () {
          return !closeDoor
            ? [
                ...
                "elemental/fairy/badEnding2.png",
              ]
            : [
    ...
    },
    {
      ...
      text: [
        ...
        [
          "As soon as you touch the door, you notice a slimy sensation instead of wood. You feel.. dizzy, enough to make you tremble. You decide to not bother with it as you turn the knock, this time not getting dizzy.",
          "elemental/fairy/black.png",
        ],
        [
        ...
        function () {
          return !closeDoor
            ? [
                "You manage to reach and open the door but your reaction time is way too slow and the wave fills the other room. With the other doors closed, it quickly fills everything, including you",
                "elemental/fairy/black.png",
              ]
            : [
                "You manage to reach the door before you're forced to swim and you turn it with all your will. You close it inmediatly and you notice how the door recives a hit but no water is filtered.",
                "elemental/fairy/black.png",
              ];
        },
      ],
    },
    {
      ...
      text: [
        ...
        [
          "You can even see a green ekans with a hat which name immediately pops up in your mind: Mr. Noodle. But there's another, real click behind you as the door is now closed",
          "elemental/fairy/black.png",
        ],
        function () {
        ...
        [
          "You decide to leave the door alone as you turn back to the peaceful room, starting to explore it. You find nothing of interest except more pokemon hidden between the grass and leaves.",
          "elemental/fairy/black.png",
        ],
        ...
        function () {
          return !acceptFate && lastButtonTouched != null && lastButtonTouched.localeCompare("Grass") == 0
            ? [
                "You try to shake this sensation off, knowing it's not right and with woobly steps you make your way to the door with the sun symbol. Somehow you manage to locate and turn the knock as you take a step out.",
                "elemental/fairy/black.png",
              ]
            : [
                "You hesitate,the fog clouding your judgement. Is it really bad being here? The door has now a moon symbol and your eyes feel heavy and you manage to turn the knock one last time before falling, but nothing happens",
                "elemental/fairy/black.png",
              ];
        },
        ...
        function () {
          return !closeDoor
            ? [
                "You manage to open the door, but you can't shake off anything of your mind. You take a step in as you hear rushing and giant vines grab you before you can even close the door, making you return to your ethernal peace.",
                "elemental/fairy/black.png",
              ]
  ...
  function getCloserMirror() {
    document.getElementById("turnRightButton").style.display = "none";
    document.getElementById("turnLeftButton").style.display = "none";
  ...
  function getBackMirror() {
    ...
    document.getElementById("turnRightButton").style.display = "block";
    document.getElementById("turnLeftButton").style.display = "block";
  ...
  function getCloserLeft() {
    ...
    for (var i = 0; i < botones.length; i++) {
      ...
      boton.classList.add("btn", "w-100", "mb-2");
    ...
    document.getElementById("rightColumn").style.setProperty("display", "inline", "important");
  }
  ...
  function goBack() {
    ...
    //recuperar botones y tal
    document.getElementById("turnRightButton").style.display = "block";
    document.getElementById("turnLeftButton").style.display = "block";

    document.getElementById("rightColumn").style.setProperty("display", "flex", "important");
  }
  ...
  function createDoorButton() {
    var botones = [
      { nombre: "Click Fairy", style: "#C942C6", text: "black", positionX: 26, positionY: 58 },
      { nombre: "Click Dark", style: "#183353", text: "white", positionX: 32, positionY: 50 },
      { nombre: "Click Ice", style: "#06C0CD", text: "black", positionX: 38, positionY: 58 },
      { nombre: "Click Water", style: "#0270C0", text: "black", positionX: 55, positionY: 50 },
      { nombre: "Click Electric", style: "#F9E100", text: "black", positionX: 50, positionY: 58 },
      { nombre: "Click Psiquic", style: "#7B3A91", text: "black", positionX: 43, positionY: 50 },
      { nombre: "Click Grass", style: "#1F9426", text: "black", positionX: 61, positionY: 58 },
  ...
  function createRefuseWindow() {
    ...
    text.innerHTML = "You refuse to enter this room. <em style='background: none; box-shadow:none; border: none;'>again</em>";
  ...
  function nextText(text) {
    ...
    //has conseguido cerrar la puerta
      ...
      botonNext.addEventListener("click", function () {
        ...
        //hacer que los botones de moverse se puedan clickar
        enableDivButton(document.getElementById('turnLeftButton'));
        enableDivButton(document.getElementById('turnRightButton'));
      });
  ...
  function createPanicButton(name) {
    ...
    panicButton.style.top = "20%"; // Alineado verticalmente en el centro
  ...
  function createExitButton(name) {
    ...
    panicButton.style.position = "absolute"; // Posicionamiento absoluto
    panicButton.style.top = "16%"; // Alineado verticalmente en el centro
    panicButton.style.left = "26%"; // Alineado horizontalmente en el centro
    ...
    continueButton.style.top = "16%"; // Alineado verticalmente en el centro
    continueButton.style.left = "72%"; // Alineado horizontalmente en el centro
    ...
    panicButton.addEventListener("click", function () {
      ...
      console.log('click');
      //los botones de movese se vuelven clickables
      enableDivButton(document.getElementById('turnRightButton'));
      enableDivButton(document.getElementById('turnLeftButton'));
    });
  ...
  function deleteTypeButtons() {
    var botones = ["Click Fairy", "Click Dark", "Click Ice", "Click Water", "Click Electric", "Click Psiquic", "Click Grass", "Click Fire"];
