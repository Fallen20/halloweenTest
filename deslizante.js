document.addEventListener('DOMContentLoaded', function () {
    ...
    function checkWinCondition() {
        ...
        if (winCondition) {
            ...
            setTimeout(() => {
                alert('You won!');
                document.getElementById('result').innerHTML="The painting seems to recover its spirit as it slowly fades into the darkness, revealing a hidden hallway behind it.<a href='./LORE/Room2/Room2_v2.html'>You can continue</a>";
